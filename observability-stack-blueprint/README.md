...
- **Company**: dmc
- **Region**: us-east-2
- **Terraform Version**: 0.31.0

## 🌍 Environments Configuration

| Environment | Region | Projects | Workloads | Terragrunt | Secrets |
|-------------|--------|----------|-----------|------------|----------|
| Laboratory | `us-east-2` | observability | observability | ✅ | ❌ |
| Shared | `us-east-2` | - | - | ✅ | ❌ |
...
#### **Example: Laboratory Environment**

```bash
# Initialize
terragrunt init --all --queue-include-dir "*/laboratory" --queue-include-dir "*/*/laboratory"

# Plan
terragrunt plan -concise --all --queue-include-dir "*/laboratory" --queue-include-dir "*/*/laboratory"

# Apply
terragrunt apply --all --queue-include-dir "*/laboratory" --queue-include-dir "*/*/laboratory"
```
